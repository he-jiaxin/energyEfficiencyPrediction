...
floorplan_fuse_map = {
    ...
    7: [224, 224, 224],  # not used
    8: [224, 224, 128],  # not used
    9: [255, 60, 128],  # extra label for opening
    10: [255, 0, 0],  # extra label for door
    11: [0, 255, 0],  # extra label for window
    12: [255, 255, 255],  # extra label for wall line
}
...
floorplan_fuse_map_figure = {
    ...
    10: [255, 0, 0],  # extra label for door
    11: [0, 255, 0],  # extra label for window
    12: [0, 0, 0],  # extra label for wall line
}
