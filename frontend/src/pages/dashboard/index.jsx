...
import { Grid, Box, Typography, Button, Stack, Modal, CircularProgress, Snackbar} from '@mui/material';
...
export default function DashboardDefault() {
  ...
  const handleConfirmRetrain = async () => {
    ...
    try {
      ...
      setRetrainError('An error occurred during retraining. Please try again.');
    } finally {
      setIsLoading(false);
  ...
  return (
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Snackbar open={retrainSuccess} autoHideDuration={6000} onClose={handleCloseSnackbar}>
        <MuiAlert onClose={handleCloseSnackbar} severity="success" sx={{ width: '100%' }}>
          Model retrained successfully!
        </MuiAlert>
      </Snackbar>
      
      <Snackbar open={!!retrainError} autoHideDuration={6000} onClose={handleCloseSnackbar}>
