...
import { Button, Grid, Stack, Typography, Box, Modal, Fade, Backdrop, Tooltip } from '@mui/material';
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    <Tooltip
                      title={
                        isPlaying
                          ? isPaused
                            ? 'Resume recommendations from where you left off.'
                            : 'Pause the recommendations to stop reading.'
                          : 'Play recommendations based on model performance.'
                      }
                      arrow
                    >
                      <Button
                        ...
                        sx={{ mt: 2 }}
                        startIcon={isPlaying ? isPaused ? <PlayArrowIcon /> : <PauseIcon /> : <PlayArrowIcon />}
                      >
